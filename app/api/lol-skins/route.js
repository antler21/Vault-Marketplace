...
export async function POST(request) {
  try {
    ...
    const {
      ...
      soloPeakRank, flexPeakRank, soloPrevRank, flexPrevRank,
      lastMatch,
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        solo_peak_rank:      soloPeakRank || null,
        flex_peak_rank:      flexPeakRank || null,
        solo_prev_rank:      soloPrevRank || null,
        flex_prev_rank:      flexPrevRank || null,
